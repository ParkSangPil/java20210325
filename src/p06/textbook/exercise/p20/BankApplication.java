package p06.textbook.exercise.p20;
...
public class BankApplication {
	...
	private static void createAccount() {
		...
		String selectacc = scanner.next();
		System.out.print("계좌주 :");
		String selectown = scanner.next();
		System.out.print("초기입금액 :");
		int selectmon = scanner.nextInt();

		Account newAccount = new Account(selectacc, selectown, selectmon);
